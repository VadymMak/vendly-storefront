...
function SocialLink({ href, label, children }: SocialLinkProps) {
  return (
    <a
      ...
      aria-label={label}
      className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-gray-400 transition-colors hover:bg-white/20 hover:text-white"
    >
      {children}
    </a>
  );
        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-4 flex gap-2">
              <SocialLink href="https://wa.me/421000000000" label="WhatsApp">
                <WhatsAppIcon />
              </SocialLink>
              <SocialLink href="https://github.com/VadymMak/vendly" label="GitHub">
                <GitHubIcon />
              </SocialLink>
