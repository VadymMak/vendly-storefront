...
export const COLOR_SCHEMES: Record<string, ColorSchemeTokens> = {
  ...
  warm: {
    ...
    accent: 'bg-[#d4641a] text-white',
    accentHover: 'hover:bg-[#b8550f]',
    border: 'border-[#e8e0d6]',
    headerBg: 'bg-white/92 backdrop-blur-xl',
    footerBg: 'bg-[#3d2c1e]',
    footerText: 'text-[#c4b5a5]',
    heroBg: 'bg-gradient-to-br from-[#2c1810] via-[#4a2d1a] to-[#3d2c1e]',
    chipBg: 'bg-[#fff3ec]',
    chipText: 'text-[#d4641a]',
    outlineBtn: 'border border-[#e8e0d6] text-[#6b6560] hover:border-[#d4641a] hover:text-[#d4641a]',
  },
  bold: {
    bg: 'bg-indigo-950',
