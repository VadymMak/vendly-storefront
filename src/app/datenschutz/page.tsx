...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung — VendShop',
  description: 'Datenschutzerklärung für VendShop (vendshop.shop) gemäß DSGVO.',
  robots: { index: false },
};
...
export default function DatenschutzPage() {
  const filePath = path.join(process.cwd(), 'legal', 'datenschutz.md');
